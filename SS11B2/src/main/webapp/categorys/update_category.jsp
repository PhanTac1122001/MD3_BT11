...
<form action="/category" method="post">
    ...
    <div class="form-group">
        <label >STATUS</label>
        <select>
            <option name="status" ${category.status ? 'checked':''} id="true" value="true">Đang bán</option>
            <option name="status" ${category.status ? 'checked':''} id="false" value="false">Hết Hàng</option>
        </select>
